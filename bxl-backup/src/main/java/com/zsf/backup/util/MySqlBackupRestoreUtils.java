...
public class MySqlBackupRestoreUtils {
    ...
    public static boolean backup(String host, String userName, String password, String backupFolderPath, String fileName, String database) throws InterruptedException, IOException {
        ...
        stringBuilder.append(" --default-character-set=utf8 ").append(database);
    ...
    public static void main(String[] args) throws Exception {
        String cmd = "mysqldump --opt  --add-drop-database  --add-drop-table  -h192.168.218.123 -uroot -p123456 --default-character-set=utf8 bxl >e:/dev/bxl.sql";
